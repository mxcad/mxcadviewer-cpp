...
class Mx2dCustomRectCloud : public Mx2dCustomAnnotation
{
	ACRX_DECLARE_MEMBERS(Mx2dCustomRectCloud);
public:
	Mx2dCustomRectCloud(void);
	Mx2dCustomRectCloud(const McGePoint3d& pt1, const McGePoint3d& pt2, double textHeight);

	virtual ~Mx2dCustomRectCloud(void);
...
protected:
	McDbPolyline* createRectCloud() const;
private:
